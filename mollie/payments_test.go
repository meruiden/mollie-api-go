...
func TestPaymentsService_Create(t *testing.T) {
	...
	res, _, err := tClient.Payments.Create(p, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestPaymentsService_Create_AccessTokens(t *testing.T) {
	...
	payment, _, err := tClient.Payments.Create(p, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestPaymentsService_HttpRequestErrors(t *testing.T) {
	...
	_, _, cerr := tClient.Payments.Create(p, nil)
...
func TestPaymentFailedResponseAvailable(t *testing.T) {
	...
	_, _, err := tClient.Payments.Create(Payment{}, nil)
